              ...
              {items.map((item) => (
                <TableRow key={item.ID}>
                    ...
                    <TableCell align="center">
                        {
                            item.accept === true ? 
                            <p  className={classes.status} onClick={handleClickViewDetails}>Voir les détails</p> 
                        : 
                            <p  className={classes.status} onClick={handleClickResend}>Renvoyer l'invitation</p>
                        }
                    </TableCell>
                    <TableCell align="right">
                        <CloseIcon className={classes.editItem} onClick={()=>props.onClickDelete(item.ID)}></CloseIcon>
                    </TableCell>
                </TableRow>
              ))}
            </TableBody>
