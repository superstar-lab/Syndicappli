        ...
        <div className={classes.paper} >
            <Grid container spacing={4} xs={12}>
                ...
                <Grid item container direction="column" spacing={2}>
                    <Grid item><p>Coordonnees</p></Grid>
                ...
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>Telephone</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} variant="outlined" /></Grid>
                </Grid>
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>SIRET</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} variant="outlined" /></Grid>
                </Grid>
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>TVA Intracommunautaire</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} variant="outlined" /></Grid>
                </Grid>
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>Compte Bancaire - Prelevement SEPA</p></Grid>
                </Grid>
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>Nom du titulaire du compte</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} variant="outlined" /></Grid>
                </Grid>
                <Grid item container alignItems="flex-start" spacing={2}>
                    <Grid item><p>Adresse</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} rows={3} multiline variant="outlined" /></Grid>
                </Grid>
                <Grid item container alignItems="center" spacing={2}>
                    <Grid item><p>IBAN</p></Grid>
                    <Grid xs item container alignItems="stretch"><TextField id="outlined-basic" className={classes.text} variant="outlined" /></Grid>
                </Grid>
                <Grid xs={12} item container direction="column"  spacing={2}>
                    <Grid item><p>Logo</p></Grid>
