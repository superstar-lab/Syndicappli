      ...
      <div className={classes.title}>
        <Grid item container justify="space-around" alignItems="center">
          ...
          <Grid item xs={12} sm={6} container justify="flex-end" >
            <Grid>
              <MyButton name = {"Nouveau membre"} color={"1"} onClick={handleClickAdd}/>
              <Dialog
                open={open}
                onClose={handleClose}
              ...
              >
                <Grid item container className={classes.padding} justify="space-between">
                  ...
                  <Grid item><h2 id="transition-modal-title" className={classes.modalTitle}>Nouveau Membre</h2></Grid>
                </Grid>
                <AddTeamMember  onCancel={handleClose} onAdd={handleAdd}/>
              </Dialog>
            </Grid>
          </Grid>
        </Grid>
