    ...
    <div className={classes.root}>
      ...
      <div className={classes.tool}>
        <Grid container spacing={2} direction="row">
          <Grid item>
            <MyButton   name={"Tout sélectionner/déselectionner"} bgColor={"#00C9FF"} onClick={handleClickAllSelect} disabled={(accessBuildings ==='See'? 'disabled' : !'disabled')}/>
          </Grid>
          <Grid item>
            <MyButton   name={"Importer"} bgColor={"#00C9FF"} onClick={handleClickImport} disabled={(accessBuildings ==='See'? 'disabled' : !'disabled')}/>
          </Grid>
          <Grid item>
            <MyButton   name={"Exporter"} bgColor={"#00C9FF"} onClick={handleClickExport} disabled={(accessBuildings ==='See'? 'disabled' : !'disabled')}/>
          </Grid>
        </Grid>
      </div> 
